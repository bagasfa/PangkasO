		...
		@if(auth()->user()->verify_status == 'Rejected')
		  <div class="alert alert-danger alert-dismissible show fade">
		    <div class="alert-body">
		      <button class="close btn-close" data-dismiss="alert"></button>
		...
		<div class="card">
			...
			<div class="card-body">
				<div class="row mt-4">
		            ...
		            <form name="VerifyForm" method="POST" action="{{url('/verify/send-verify')}}" enctype="multipart/form-data" class="wizard-content mt-2">
		              {{csrf_field()}}
