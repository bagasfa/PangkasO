            ...
            <form action="{{ url('/admin-panel/updatePassword') }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group">
                  ...
                  <div class="input-group" id="show_hide_password">
                    <input name="oldPassword" type="password" minlength="8" class="form-control" id="oldPassword" required="">
              ...
              <div class="form-group">
                  ...
                  <div class="input-group" id="show_hide_password">
                    <input name="newPassword" type="password" minlength="8" class="form-control" id="newPassword" required="">
                    <a href=""><div class="input-group-addon eye">
                      <i class="fa fa-eye-slash" aria-hidden="true"></i>
                    </div></a>
                  </div>
              ...
              <div class="form-group">
                  ...
                  <div class="input-group" id="show_hide_password">
                    <input name="confirmPassword" type="password" minlength="8" class="form-control" id="confirmPassword" required="">
                    <a href=""><div class="input-group-addon eye">
                      <i class="fa fa-eye-slash" aria-hidden="true"></i>
                    </div></a>
                  </div>
